...
notes = {
    "Welcome":{
        "текст":"Ласкаво просимо до програми 'Розумні замітки'",
        "теги":["інстрункція"]
    }
}
...
button_note_create = QPushButton("Сворити нотатку")
...
button_tag_search = QPushButton('Пошук по тегу')
...
def del_note():
    if list_notes.selectedItems():
        ...
        print("Нотатка для видалення не обрана!")
